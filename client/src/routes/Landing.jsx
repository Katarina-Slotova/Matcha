				...
				<div className="row align-items-center">
					<div className="col-lg-6 col-xl-5 ms-xl-auto px-lg-4 text-center text-primary">
						<div style={{padding: "10px"}}>
							<Button size="lg" className="col btn btn-purple-moon" onClick={navigateLogin}>Log in</Button>
						</div>
						<div style={{padding: "10px"}}>
							<Button size="lg" className="col btn btn-pink-moon" onClick={navigateSignup}>Sign up</Button>
						</div>
					</div>
